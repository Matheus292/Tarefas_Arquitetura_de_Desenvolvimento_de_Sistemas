...
<body>
	...
	<div id="main" class="container">
		...
		<form name="formulario" action="controller.do?command=SalvarAlteracao" method="post">
		...
		<input type="hidden" name="cnpj" value= "${ empresa.cnpj }" />
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label>Telefone:</label> <input type="tel" name="fone" required
						id="fonte" class="form-control" pattern="(?:\(\d{2}\)|\d{2})[- ]?\d{5}[- ]?\d{4}"
			...
			<br> <input type="submit" class="btn btn-success"
				...
				<a href="controller.do?command=ListarEmpresa"
